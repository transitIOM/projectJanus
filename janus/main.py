...
from janus.Compiler.stops import de_duplicate, add_stop
from janus.ODM.mongo_initialize import init_mongo

from janus.Compiler.jsonReformatter import reformat
# from Parser import AiProcessing

init_mongo()

stops = add_stop("janus/output.json")
stops = de_duplicate(stops)
